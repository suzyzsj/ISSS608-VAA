...
```{r}
exam_data <- read_csv("/Users/zhangshujie/Desktop/SMU/Term 2/Visual/suzyzsj/ISSS608-VAA/Hands-on_Ex/Hands-on_Ex01/data/Exam_data.csv")
```

## **Interactive Data Visualisation - ggiraph methods**

[ggiraph](https://davidgohel.github.io/ggiraph/) ![](https://r4va.netlify.app/chap03/img/image1.jpg){width="47"} is an htmlwidget and a ggplot2 extension. It allows ggplot graphics to be interactive.
...
![](images/clipboard-3679506280.png){width="1492"}
