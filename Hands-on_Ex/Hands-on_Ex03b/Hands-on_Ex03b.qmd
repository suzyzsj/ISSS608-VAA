...
![](images/clipboard-3034942173.png)
...
-   [`mutate_at()`](https://r4va.netlify.app/chap04)[`across()`](https://dplyr.tidyverse.org/reference/across.html) are used to convert all character data type into factor.
