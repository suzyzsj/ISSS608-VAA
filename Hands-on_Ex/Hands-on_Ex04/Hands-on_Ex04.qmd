...
The downloaded binary packages are in C:\Users\tskam\AppData\Local\Temp\RtmpcJX3aB\downloaded\_packages package 'ggridges' successfully unpacked and MD5 sums checked

The downloaded binary packages are in C:\Users\tskam\AppData\Local\Temp\RtmpcJX3aB\downloaded\_packages
...
```{r}
exam <- read_csv("/Users/zhangshujie/Desktop/SMU/Term 2/Visual/suzyzsj/ISSS608-VAA/Hands-on_Ex/Hands-on_Ex04/data/Exam_data.csv")
```
...
![](images/clipboard-3892907687.png)
