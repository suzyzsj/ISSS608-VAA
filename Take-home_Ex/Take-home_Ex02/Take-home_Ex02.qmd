...
-   In the first chart, detailed annotations have been added, including the calculation of specific mean and median values. mean_value \<- mean(stu_qqq_socio$Socioeconomic_Stat, na.rm = TRUE) median_value <- median(stu_qqq_socio$Socioeconomic_Stat, na.rm = TRUE)

-   In the second chart, three different colors were used to distinguish the three subjects, making it visually more appealing and clear. color_math \<- "#89A0B0"\
